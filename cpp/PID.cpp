...
PIDController<T1, T2>::PIDController(double p, double i, double d, T1 (*pidSource)(T2* context), void (*pidOutput)(T1 output, T2* context))
{
  _p = p;
  _i = i;
  _d = d;
 ...
 * @param (*pidSource) The function pointer for retrieving system feedback.
 * @param (*pidOutput) The function pointer for delivering system output.
 * @param (*context) The pointer for the object which is holding pidSource and pidOutput.
 */
template <class T1, class T2>
PIDController<T1, T2>::PIDController(double p, double i, double d, T1 (*pidSource)(T2* fContext), void (*pidOutput)(T1 output, T2* fContext), T2* context)
: PIDController(p, i, d, 0, 0)
{
  this->context = context;
  this->_pidSourceContext = pidSource;
  this->_pidOutputContext = pidOutput;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::tick()
{
  if(enabled)
  {
    //Retrieve system feedback from user callback.
	if (context)
		currentFeedback = _pidSourceContext(context);
	else
    ...
    if (context)
    	_pidOutputContext(output, context);
    else
    	_pidOutput(output);
  }
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setTarget(T1 t)
{
  target = t;
}
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getTarget()
{
  return target;
}
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getOutput()
{
  return output;
}
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getFeedback()
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getError()
{
  return error;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setEnabled(bool e)
{
 ...
 */
template <class T1, class T2>
bool PIDController<T1, T2>::isEnabled()
{
  return enabled;
}
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getProportionalComponent()
{
  return (T1) (error * _p);
}
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getIntegralComponent()
{
  return (T1) (integralCumulation * _i);
}
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getDerivativeComponent()
{
  return (T1) (cycleDerivative * _d);
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setMaxIntegralCumulation(T1 max)
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getMaxIntegralCumulation()
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getIntegralCumulation()
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setInputBounded(bool bounded)
{
 ...
 */
template <class T1, class T2>
bool PIDController<T1, T2>::isInputBounded()
{
  return inputBounded;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setInputBounds(T1 lower, T1 upper)
{
  if(upper > lower)
  {
    inputBounded = true;
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getInputLowerBound()
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getInputUpperBound()
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setOutputBounded(bool bounded)
{
 ...
 */
template <class T1, class T2>
bool PIDController<T1, T2>::isOutputBounded()
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setOutputBounds(T1 lower, T1 upper)
{
  if(upper > lower)
  {
    outputBounded = true;
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getOutputLowerBound()
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getOutputUpperBound()
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setFeedbackWrapped(bool wrapped)
{
 ...
 */
template <class T1, class T2>
bool PIDController<T1, T2>::isFeedbackWrapped()
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setFeedbackWrapBounds(T1 lower, T1 upper)
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getFeedbackWrapLowerBound()
{
 ...
 */
template <class T1, class T2>
T1 PIDController<T1, T2>::getFeedbackWrapUpperBound()
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setPID(double p, double i, double d)
{
  _p = p;
  _i = i;
  _d = d;
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setP(double p)
{
  _p = p;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setI(double i)
{
  _i = i;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setD(double d)
{
  _d = d;
}
 ...
 */
template <class T1, class T2>
double PIDController<T1, T2>::getP()
{
  return _p;
}
 ...
 */
template <class T1, class T2>
double PIDController<T1, T2>::getI()
{
  return _i;
}
 ...
 */
template <class T1, class T2>
double PIDController<T1, T2>::getD()
{
  return _d;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setPIDSource(T1 (*pidSource)())
{
  _pidSource = pidSource;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setPIDSource(T1 (*pidSource)(T2* context))
{
  _pidSourceContext = pidSource;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setPIDOutput(void (*pidOutput)(T1 output))
{
  _pidOutput = pidOutput;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::setPIDOutput(void (*pidOutput)(T1 output, T2* context))
{
  _pidOutputContext = pidOutput;
}
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::registerTimeFunction(unsigned long (*getSystemTime)())
{
 ...
 */
template <class T1, class T2>
void PIDController<T1, T2>::reset()
{
	this->_p = 0.0f;
	this->_i = 0.0f;
	this->_d = 0.0f;
