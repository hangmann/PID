 ...
 */
template <class T>
PIDController<T>::PIDController(double p, double i, double d, T (*pidSource)(void* context), void (*pidOutput)(T output, void* context))
{
  _p = p;
  _i = i;
  _d = d;
 ...
 */
template <class T>
PIDController<T>::PIDController(double p, double i, double d, T (*pidSource)(void* fContext), void (*pidOutput)(T output, void* fContext), void* context)
 ...
 */
template <class T>
void PIDController<T>::setPIDSource(T (*pidSource)(void* context))
{
 ...
 */
template <class T>
void PIDController<T>::setPIDOutput(void (*pidOutput)(T output, void* context))
{
